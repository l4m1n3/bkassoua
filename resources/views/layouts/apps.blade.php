...
<head>
    ...
    <link href="{{asset('/asssetslib/animate/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('/asssets/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
...
<body>
                ...
                <div class="d-inline-flex align-items-center">
                    <a href="" class="navbar-brand p-0">
                        <h1 class="display-5 text-primary m-0"><i
                                class="fas fa-shopping-cart text-secondary me-2"></i>B-KASSOUA</h1>
                        {{-- <img src="{{ asset('assets/img/logo_nav.png') }}" alt="Logo"> --}}
                    </a>
                </div>
            </div>
                ...
                <div class="position-relative ps-4">
                    <div class="d-flex border rounded-pill">
                        <input class="form-control border-0 rounded-pill w-100 py-3" type="text"
                            data-bs-target="#dropdownToggle123" placeholder="Rechercher un article?">
 ...
 @yield('content')
            ...
            <div class="row g-4 rounded mb-5" style="background: rgba(255, 255, 255, .03);">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="rounded p-4">
                        ...
                        <div>
                            <h4 class="text-white">contact@b-kassoua.com</h4>
                            <p class="mb-2">(+227) 3456 7890</p>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('asssets/lib/wow/wow.min.js')}}"></script>
    <script src="{{{asset('asssets/lib/owlcarousel/owl.carousel.min.js')}}}"></script>
